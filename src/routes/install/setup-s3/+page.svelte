...
<form action="?/setupS3" method="post" use:enhance class="flex flex-col gap-4 mt-6" on:submit={() => formSent = true}>
    ...
    <FormInput label={$_('app.setup_s3.s3_region')} name="s3_region" type="select" required labelMandatory autocomplete="s3_region">
    ...
    <FormInput label={$_('app.setup_s3.s3_bucket')} name="s3_bucket" type="text" required labelMandatory autocomplete="s3_bucket" />
