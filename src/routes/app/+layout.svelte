<script lang="ts">
  ...
  import { ListBullet, CircleStack } from "@steeze-ui/heroicons";
...
<Flex gap={0} class="h-screen overflow-hidden">
  ...
  <div class="shrink-0 h-screen bg-zinc-100 border-r-zinc-500/50 shadow-2xl border">
      ...
      <div class="grow p-6">
        <Flex direction="col" gap={3}>
          <a href="/app/articles" 
            ...
            class:text-blue-500={$page.route.id?.includes("/app/articles")}
          >
            <Icon src={CircleStack} class="h-5 w-5 mb-0.5 inline"/>
            Base articles
          </a>
          <a href="/app/nomenclatures" 
            class="hover:text-violet-500 hover:font-medium"
            class:text-blue-500={$page.route.id?.includes("/app/nomenclatures")}
          >
          ...
          <a href="/app/lists" 
            class="hover:text-violet-500 hover:font-medium"
            class:text-blue-500={$page.route.id?.includes("/app/lists")}
          >
            <Icon src={ListBullet} class="h-5 w-5 mb-0.5 inline"/>
            Listes
          </a>
