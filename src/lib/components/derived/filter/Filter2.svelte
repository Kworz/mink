<script lang="ts">
    import FilterLabel from "$lib/components/derived/filter/FilterLabel.svelte";
    import { appendFilter, converToPrismaFilter, convertFilterCondition, predictField, type Filter, type FilterCondition, type PrismaFilter } from "$lib/components/derived/filter/filter2";
